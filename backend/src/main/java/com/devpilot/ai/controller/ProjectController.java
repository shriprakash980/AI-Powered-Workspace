...
public class ProjectController {
    ...
    @GetMapping
    @Operation(summary = "List all active projects", description = "Retrieves active cloud workspaces belonging to the authenticated user context.")
    public ResponseEntity<ApiResponse<List<ProjectResponse>>> getAllProjects(
            @AuthenticationPrincipal UserPrincipal userPrincipal) {
        log.info("REST request to get active projects for user: {}", userPrincipal != null ? userPrincipal.getId() : "all");
    ...
    public ResponseEntity<ApiResponse<ProjectResponse>> getProjectById(
        ...
        ProjectResponse project = projectService.getProjectById(id, userPrincipal);
    ...
    public ResponseEntity<ApiResponse<ProjectResponse>> createProject(
        ...
        ProjectResponse project = projectService.createProject(request, userPrincipal);
    ...
    public ResponseEntity<ApiResponse<ProjectResponse>> updateProject(
        ...
        ProjectResponse updated = projectService.updateProject(id, request, userPrincipal);
